...
- 6 тестов. Офлайн-архивы в `offline-bundles` собраны ДО этих изменений (нет openai и новых вкладок) —
  при необходимости пересобрать `bash tools/build_portable.sh`.
