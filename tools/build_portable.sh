...
# openai_key.txt в архивы не кладём: ключ копируется в распакованную папку вручную (см. README)
FILES=(.streamlit moneygraph app data output tests conftest.py requirements.txt README.md README_dataset.md DESIGN.md
       run.sh run.ps1 run_offline.sh run_offline.bat docs)
