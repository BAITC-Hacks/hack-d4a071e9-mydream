...
После загрузки карты **под графом автоматически появляется аналитика от Sol**:
...
- Ниже остаётся свободный вопрос по кнопке **«Спросить GPT-6 Sol»**.
...
У 444 узлов глубины 4 нет исходящих переводов, но обход на них закончился, поэтому их собственные исходящие неизвестны. Эталон: узлы колен 1–3 с входящими переводами, чьи исходящие обход проследил по тем же правилам (июль, от 5 000 ₸, внутри банка). Для них видно, кто действительно отправил деньги дальше. Эталон делится по числу входящих операций узла, самому сильному наблюдаемому признаку продолжения:
